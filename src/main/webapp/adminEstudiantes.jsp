...
<div class="p-6">
  <div class="flex items-center justify-between mb-4">
    ...
    <button class="bg-green-500 text-white px-4 py-2 rounded hover:bg-green-600">+ Nuevo Estudiante</button>
  </div>
    ...
    <table class="min-w-full divide-y divide-gray-200">
      ...
      <tbody class="bg-white divide-y divide-gray-200">
        <tr>
          ...
          <td class="px-6 py-4 text-sm text-gray-900">mtorres@colegio.edu</td>

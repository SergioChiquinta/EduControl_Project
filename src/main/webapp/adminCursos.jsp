...
<div class="p-6">
    <div class="flex items-center justify-between mb-4">
        ...
        <button class="bg-green-500 text-white px-4 py-2 rounded hover:bg-green-600">+ Nuevo Curso</button>
    </div>
    ...
    <div class="overflow-x-auto bg-white shadow rounded-lg">
        <table class="min-w-full divide-y divide-gray-200">
            <thead class="bg-gray-100">
                <tr>
                    <th class="px-6 py-3 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">ID Curso</th>
                    <th class="px-6 py-3 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">Materia</th>
                    <th class="px-6 py-3 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">Salón</th>
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                <tr>
                    <td class="px-6 py-4 text-sm text-gray-900">C001</td>
                    <td class="px-6 py-4 text-sm text-gray-900">Matemática Básica</td>
                    <td class="px-6 py-4 text-sm text-gray-900">Salón 101</td>
